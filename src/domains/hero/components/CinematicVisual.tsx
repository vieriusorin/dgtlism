...
const CinematicVisual: React.FC<TCinematicVisualProps> = () => {
	return (
		<div
			className='transition-all duration-1000 delay-1200 translate-x-0 opacity-100'
			style={{
				animation:
		...
		>
			<div className='relative w-full h-96 max-w-2xl mx-auto overflow-hidden'>
				{/* Film grain overlay */}
				<div
					className='absolute inset-0 bg-black/30 mix-blend-overlay z-10'
					style={{
				...
				<div className='absolute inset-0 z-20'>
					{[...Array(6)].map((_, i) => (
						<div
							key={i}
							className='absolute h-px bg-linear-to-r from-transparent via-cyan-400/30 to-transparent w-full'
							style={{
								top: `${15 + i * 12}%`,
				...
				{/* Holographic display */}
				<div
					className='absolute inset-16 bg-linear-to-br from-cyan-500/10 via-purple-500/10 to-pink-500/10 border border-white-200 border-cyan-400/30 z-10'
					style={{
						backdropFilter: "blur(2px)",
						boxShadow:
							"0 0 50px rgba(34, 211, 238, 0.2), inset 0 0 50px rgba(34, 211, 238, 0.1)",
					}}
				>
					...
					<div className='p-6 font-mono text-sm text-cyan-400 h-full flex flex-col justify-center'>
						...
						<div className='mb-2'>
							<span className='text-yellow-400'>[LOADING]</span> Creative
							assets... ✓
						</div>
						<div className='mb-2'>
							<span className='text-yellow-400'>[LOADING]</span> Code
							repositories... ✓
						</div>
						<div className='mb-2'>
							<span className='text-yellow-400'>[LOADING]</span> Design
							systems... ✓
						</div>
						<div className='mb-4'>
